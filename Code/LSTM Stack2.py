...
# Parameters
stepr=1
learning_rate = 1/stepr       #10^-5   0.0001 0.00001 0.000001 0.000005 0.002 0.002/stepr
learning_rate_ori=1/stepr
training_iters = 10000000         #996500  1000000000 100000000
# training_iters = 1000
batch_size = 1000
display_step = 5
keep_prob=0.5
...
n_hidden = 30  # hidden layer num of features 200 30
# n_hidden = n_steps
...
def RNN(x, weights, biases):
    ...
    lstm_cell = rnn_cell.BasicLSTMCell(n_hidden, forget_bias=0.0,state_is_tuple=True)
    if keep_prob<1:
...
with tf.Session() as sess:
    ...
    plt.savefig('./fig/%s_%s_%s_%s_%s.png' % (n_input, n_hidden, str(learning_rate_ori), training_iters,num_layers))
